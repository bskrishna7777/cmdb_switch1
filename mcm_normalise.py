...
def main():
    ...
    df1 = pd.read_excel("Primary CMDB 1 2.xlsx")
    
    #***********************************************
    #=========== Second File (csv or xlsx) =========
    df2 = pd.read_csv("Server_MCM_Raw.csv")
    ...
    df_filtered_list2.to_excel("Server-MCM-NormMetada.xlsx", index=False)
    output_path = "Server-MCM-NormMetada.xlsx"
