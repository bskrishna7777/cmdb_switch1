...
def standardize_with_llamaindex(xl_path, output_path):
    # Load the data
    ...
    standardize_prompt = PromptTemplate(
        ...
        I will provide you with a list of Operating System identifiers that represent similar operating systems or vendors.
        ...
        - Provide a confidence score between 0.0 and 100.0 for each mapping that reflects how certain you are about the mapping.
...
def main(input_path, output_path):
    df, mapping, average_confidence = standardize_with_llamaindex(input_path, output_path)
